...
role :app,  "theballot@65.74.169.199:8051", :no_release => true
...
task :after_update_code, :roles => :app do
  run <<-CMD
    ...
    ln -s #{shared_path}/config/mongrel_cluster.yml #{release_path}/config/mongrel_cluster.yml &&
    rake tmp:create
  CMD
end
