class Guide < ActiveRecord::Base
  ...
  def to_liquid
    liquid = { 'id' => id, 'name' => name, 'city' => city, 'state' => state, 'date' => date, 'description' => description, 'contests' => contests, 'theme' => theme, 'endorsed' => endorsed?, 'permalink' => permalink_url }
    if image
